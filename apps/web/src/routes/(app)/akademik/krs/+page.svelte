...
<form method="GET" class="surface-panel my-6 grid gap-4 p-5 sm:grid-cols-2 lg:grid-cols-3" use:seamlessFilter>
  ...
  <div class="flex items-end gap-3"><button class="min-h-10 rounded-lg bg-brand-700 px-4 text-sm font-semibold text-white shadow-sm hover:bg-brand-800">Terapkan filter</button><a href={page.url.pathname} data-sveltekit-noscroll class="py-2 text-sm text-slate-600">Reset filter</a></div>
</form>
