...
function fixture() {
  ...
  const academic: AuthUser = { id: uuid(), loginId: '9002', email: 'academic@test.local', role: 'AKADEMIK', mustChangePassword: false };
  const lecturerUser: AuthUser = { id: uuid(), loginId: '9003', email: 'dosen@test.local', role: 'DOSEN', mustChangePassword: false };
  const foreignLecturer: AuthUser = { id: uuid(), loginId: '9004', email: 'foreign@test.local', role: 'DOSEN', mustChangePassword: false };
